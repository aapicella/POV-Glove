...
void sendByteOut(byte value) {
   digitalWrite(leds[6], value & 1);
   digitalWrite(leds[5], value & 2);
   digitalWrite(leds[4], value & 4);
   digitalWrite(leds[3], value & 8);
   digitalWrite(leds[2], value & 16);
   digitalWrite(leds[1], value & 32);
   digitalWrite(leds[0], value & 64);
...
void printLetter(int index, bool forward)
{
  int y=0;
  for (int x=0; x< 5; x++){
   y=( forward == true)?x:4-x;
   sendByteOut(font[index][y]);
  }
}
